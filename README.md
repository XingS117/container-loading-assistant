...
面向外贸装柜场景的轻量计算网站。选择单个柜型，录入散箱或整托货物后，一次生成“装得多、更加稳妥、方便操作、严格完整支撑、互叠高装载”五个可比较方案（互叠高装载支持小件叠放在组合支撑平面上、装载率更高），并提供 3D、俯视、侧视、柜门和分层布局图。
...
- "更稳妥"在保持"装得多"同一批货物的前提下做柜长方向（两头）配重：纯整托订单按重量从柜中心向外网格配平，混装/散箱订单做同底面互换优化，并分别展示前后与左右偏差。
